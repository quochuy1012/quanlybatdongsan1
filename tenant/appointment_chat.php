...
$appointment = dbSelectOne(
    "SELECT a.id, a.status, p.title as property_title, u.full_name as landlord_name, u.id as landlord_id
     FROM appointments a
    ...
    if ($message === '') {
        ...
        dbExecute(
            ...
            [
                ...
                ':receiver_id' => (int)$appointment['landlord_id'],
                ':message' => $message
            ]
        );
...
// Đánh dấu đã đọc các tin từ landlord gửi cho tenant.
dbExecute(
...
$pageTitle = "Nhắn tin người cho thuê";
include '../includes/header.php';
?>

<div class="container">
    <div class="chat-container">
        <h2 class="section-title" style="padding:1rem; margin:0;">💬 Nhắn tin với người cho thuê</h2>
        <div style="padding: 0 1rem 1rem 1rem; color:#555;">
            <strong>BĐS:</strong> <?php echo htmlspecialchars($appointment['property_title']); ?><br>
            <strong>Người cho thuê:</strong> <?php echo htmlspecialchars($appointment['landlord_name']); ?>
        </div>
